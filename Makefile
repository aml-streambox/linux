...
drivers-$(CONFIG_AMLOGIC_TEE) += $(COMMON_DRIVERS_DIR)/drivers/tee/
drivers-$(CONFIG_AMLOGIC_SND_SOC) += $(COMMON_DRIVERS_DIR)/sound/soc/amlogic/
drivers-$(CONFIG_AMLOGIC_SND_SOC_CODECS) += $(COMMON_DRIVERS_DIR)/sound/soc/codecs/amlogic/
drivers-$(CONFIG_AMLOGIC_MEDIA_MODULE) += $(COMMON_DRIVERS_DIR)/drivers/media/
drivers-$(CONFIG_AMLOGIC_MEDIA_MODULE) += $(COMMON_DRIVERS_DIR)/drivers/media_modules/
